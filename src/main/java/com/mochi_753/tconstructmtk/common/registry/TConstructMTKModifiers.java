...
import com.mochi_753.tconstructmtk.common.modiffier.ModifierMTKArmor;
...
public class TConstructMTKModifiers {
    ...
    public static final StaticModifier<NoLevelsModifier> MTK_ARMOR_MODIFIER = MODIFIERS.register("mtk_armor", ModifierMTKArmor::new);
